...
⚠️ **包含此许可证的项目仓库需要注意**，这**不是**开源许可证。源代码公开仅供学习与参考，使用权利受到严格限制。
 
### ✅ 允许
 
- 阅读、学习源代码
- 在本地私有设备上运行（仅供个人测试）
- Fork 后向本项目提交 Pull Request（贡献代码）
- 在个人 NAS / 家庭服务器上自托管，供**本人及家庭成员**私人使用（须启用鉴权、禁止收费、禁止对外公开）
### ❌ 禁止
 
- 将本项目或其修改版本部署为任何**对外公开的服务**
- 任何形式的**商业使用**（含间接获利）
- 向任何第三方**分发**本项目或其修改版本
- 删除或修改代码中的**版权声明**
...
欢迎提交 PR。提交贡献即视为授权著作权人在全球范围内永久、无偿使用该贡献；贡献者保留其贡献的著作权。
...
此许可证尽可能的保证了个人环境中的使用，强制限制了商业使用等问题，并且限制不能使用源代码/更改后的代码逃离许可证的限制
